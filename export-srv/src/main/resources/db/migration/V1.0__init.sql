...
create sequence import_task_error_id_seq start with 1 increment by 1;
...
create table import_task_error
(
    id             bigint       not null DEFAULT nextval('import_task_error_id_seq') primary key,
...
alter table if exists import_task_error
    add constraint FK_import_task_error_import_task_id foreign key (import_task_id) references import_task;
